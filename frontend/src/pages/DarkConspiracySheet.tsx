...
import { getDefaultDarkConspiracyData, useDarkConspiracyStore, type DarkConspiracyData, type MysteryRecord } from "@/lib/dark_conspiracy_store"
    ...
    return (
        <section className="space-y-2">
            ...
            {mysteries.map((mystery, index) => (
                <div key={mysteryKeys[index] ?? mystery.name} className="space-y-1 border-b border-dark-secondary/25 pb-2">
...
const DarkConspiracySheet = () => {
    ...
    const replaceCurrentDarkConspiracy = useDarkConspiracyStore((state) => state.replaceCurrentDarkConspiracy)
        ...
        input.addEventListener("change", (event) => {
            ...
            reader.addEventListener("load", (readerEvent) => {
                try {
                    ...
                    replaceCurrentDarkConspiracy({ ...getDefaultDarkConspiracyData(), ...result.data, id: undefined, version: undefined })
    ...
    return (
        <div className="mx-auto flex w-full max-w-[1500px] flex-col gap-4">
            <div className="flex justify-end gap-2">
                ...
                <Button onClick={handleUpload} className="h-8 bg-dark-secondary text-primary hover:bg-dark-secondary/90 dark-ring">
            ...
            <article className="dark-conspiracy-page">
                <header className="dark-conspiracy-header">
                    ...
                    <p>Use this sheet to track the history, motivations, and actions of the Midwives of the Fragrant Void.</p>
                </header>
                ...
                <div className="grid flex-1 grid-cols-3 gap-5">
                    <section>
                        ...
                        <p className="dark-conspiracy-copy">
                            ...is always the Midwives' first appearance in the story. It should be brief, and you should emphasize
                            their smooth white masks.
                        </p>
                        <KeeperTextarea
                        ...
                        <p className="dark-conspiracy-copy">
                            This layer is unlocked after the Mavens discover the FIRST Void Clue. At session end, show hooded figures
                            chanting on a moonlit beach as a shadow rises from the ocean.
                        </p>
                    ...
                    <section className="col-span-2">
                        <h3 className="dark-conspiracy-section-title">Layer Two: The History of Brindlewood Bay</h3>
                        <p className="dark-conspiracy-copy">
                            This layer is unlocked after THREE Void Clues. Reveal these details as a 12+ on the Meddling Move, or as
                            a Keeper reaction: Reveal the town history.
                        </p>
            ...
            <article className="dark-conspiracy-page">
                ...
                <div className="grid flex-1 grid-cols-[1.1fr_1.1fr_0.9fr] gap-5">
                    <section>
                        <h3 className="dark-conspiracy-section-title">Layer Three: The Existence of the Midwives of the Fragrant Void</h3>
                        <p className="dark-conspiracy-copy">
                            This layer is unlocked after FIVE Void Clues. Reveal these details, in order, as a 12+ on The Meddling
                            Move, or as a Keeper reaction: Reveal the Midwives.
                        </p>
                        ...
                        <KeeperTextarea
                            ...
                            onChange={(connectedCharactersLayerThree) => update({ connectedCharactersLayerThree })}
                            minRows={4}
                        />
                    </section>

                    <section>
                        <h3 className="dark-conspiracy-section-title">Layer Four: Direct Action Against the Murder Mavens</h3>
                        <p className="dark-conspiracy-copy">
                            This layer is unlocked after TEN Void Clues. The Midwives can now take direct action with Magic of the
                            Midwives.
                        </p>
                        <h4 className="dark-conspiracy-subtitle">Sendings</h4>
                        <p className="dark-conspiracy-copy">
                            Cut away to the Midwives performing a ritual, then cut to the calamitous effects of their sorcery.
                        </p>
                        ...
                        <KeeperTextarea
                            ...
                            minRows={5}
                        />
                        <FieldLabel>Final revision of the Child of Persephone and the Midwives' plan</FieldLabel>
                        <KeeperTextarea
                        ...
                        <p className="dark-conspiracy-copy">
                            This layer is unlocked after FIFTEEN Void Clues. Create the Void Mystery and present it once the current
                            mystery is resolved.
                        </p>
                    </section>

                    <MysteryTracker mysteries={current.mysteries} onChange={(mysteries) => update({ mysteries })} />
                </div>
            </article>
        </div>
    )
