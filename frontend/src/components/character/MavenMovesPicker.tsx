...
const MavenMovesPicker = () => {
  ...
  const handleMavenMoveSelect = (mavenMove: {
    title: string;
    description: string;
    summary: string;
  }) => {
              ...
              return (
                <div
                  ...
                  className={`border-1 p-2 border-t-0 border-green-200 cursor-pointer ${
                    isSelected
                      ? "border border-[#999999] bg-green-100/20 hover:bg-green-100/30"
                      : "hover:bg-tertiary/30"
                  }`}
                  onClick={() => handleMavenMoveSelect(mavenMove)}
                >
                  <div className="relative">
                    <h3 className="flex items-center text-[1.2rem] text-primary">
                      {mavenMove.title}
                    </h3>
