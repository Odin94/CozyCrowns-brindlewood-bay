...
const CookieHeader = () => (
  <div className="flex items-center gap-2">
    ...
    <img src="/queen-svgrepo-com.svg" alt="" className="h-5 w-5" aria-hidden="true" />
  </div>
);

const CookieBody = () => (
  <Trans>
    I use cookies to get better insights on usage patterns, which helps me improve Cozycrowns for
    everyone.
    <br />
    More info:{" "}
    <a
  ...
  (
      ...
      return (
        <div {...commonWrapperProps}>
          <Card
            ...
            style={{ backgroundColor: "hsl(280 25% 65%)", borderColor: "hsl(280 25% 63%)" }}
          >
    ...
    if (variant === "mini") {
      return (
        <div {...commonWrapperProps}>
          <Card
            className="mx-3 p-0 py-3 shadow-lg"
            style={{ backgroundColor: "hsl(280 25% 65%)", borderColor: "hsl(280 25% 63%)" }}
          >
